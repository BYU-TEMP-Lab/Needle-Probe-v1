...
r_wir_mid = .391629E-3; % inside radius up to middle of wires %Not needed right now, but may be needed later
r_wir_o = .485942E-3; % inside radius up to outside of wires
r_sheath_i = 0.8293E-3; % inside radius of sheath
r_sheath_o = 1.388E-3; % outside radius of the probe

% Lengths
L_probe = 0.1; % Length of the probe sensing region
L_cyl_wire = L_probe-0.01; % Length of heating wires inside sensing region
L_cyl_probe = L_probe-r_sheath_o; % Length of cylindrical portion of sensing region
