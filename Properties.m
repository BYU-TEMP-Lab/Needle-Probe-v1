...
par_names(3,1) = "K\_Insulation";           
par_names(4,1) = "Alpha\_Insulation";  
par_names(5,1) = "Rth\_Insulation-Sheath";  
par_names(6,1) = "K\_Sheath";           
par_names(7,1) = "Alpha\_Sheath"; 
par_names(8,1) = "K\_Sample";
par_names(9,1) = "Alpha\_Sample";
par_names(10,1) = "K\_Crucible";
par_names(11,1) = "Alpha\_Crucible";
par_names(12,1) = "Emissivity\_Probe";
par_names(13,1) = "Emissivity\_Crucible";
par_names(14,1) = "Index\_of\_Refraction";
...
par_names(25,1) = "h\_convection";
par_names(26,1) = "Rho\_Sample";
par_names(27,1) = "Cp\_sample";
par_names(28,1) = "Rho\_cp\_sample";
...
par_names(3,2) = "W/(m*K)";          
par_names(4,2) = "m^2/s";
par_names(5,2) = "Rth\_Insulation-Sheath";  
par_names(6,2) = "W/(m*K)";          
par_names(7,2) = "m^2/s";
par_names(8,2) = "W/(m*K)";
par_names(9,2) = "m^2/s";
...
par_names(12,2) = "emissivity\_units";
par_names(13,2) = "emissivity\_units";
par_names(14,2) = "index\_of\_refraction\_units";
par_names(15,2) = "scatter\_units";
par_names(16,2) = "°C";
